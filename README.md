...
[Type inference for Haskell](https://jeremymikkola.com/posts/2019_01_01_type_inference_intro.html),
which is in turn based on [Typing Haskell in Haskell](https://web.cecs.pdx.edu/~mpj/thih/)

### `loxjs` — Lox implementation in JavaScript

[Crafting Interpreters, part II](https://craftinginterpreters.com/a-tree-walk-interpreter.html)
